...
class GetArrayLength(JNISimProcedure):
    ...
    def run(self, *args, **kwargs):
        # TODO
        l.warning(f'GetArrayLength: TODO check implementation.')
        # .union(0) ? TODO
...
class NewObjectArray(JNISimProcedure):
    ...
    # ptr_env, length_, element_type_, initial_element_
    arguments_ty = ('jenv', 'long', 'reference', 'reference')
    return_ty = 'reference'
...
class GetObjectArrayElement(JNISimProcedure):
    ...
    # ptr_env, array_, idx_
    arguments_ty = ('jenv', 'reference', 'long')
    return_ty = 'reference'
...
class SetObjectArrayElement(JNISimProcedure):
    ...
    # ptr_env, array_, idx_, value_
    arguments_ty = ('jenv', 'reference', 'long', 'reference')
    return_ty = 'reference'
...
class GetArrayElements(JNISimProcedure):
    ...
    # ptr_env, array_, ptr_isCopy
    arguments_ty = ('jenv', 'reference', 'pointer')
    return_ty = 'reference'
...
class ReleaseArrayElements(JNISimProcedure):
    ...
    # ptr_env, array_, ptr_elems, mode_
    arguments_ty = ('jenv', 'reference', 'pointer', 'long')
    return_ty = 'void'
...
class GetArrayRegion(JNISimProcedure):
    ...
    # ptr_env, array_, start_idx_, length_, ptr_buf
    arguments_ty = ('jenv', 'reference', 'long', 'long', 'pointer')
    return_ty = 'void'
